            ...
            <div class="flex w-full">
                ...
                <div className="w-4/5 p-10">
                    <div className="w-1/2 p-4 m-auto rounded-md shadow-md shadow-i-amber-500/20">
                        <p className='text-lg font-bold text-center text-i-amber-500'>Tambah Pengguna</p>
                        <form action="" method='post' className='flex flex-col justify-center'>
                            ...
                            <div className="mt-4">
                                ...
                                <select name="role" id="role" className='block w-full mt-1 rounded-md focus:border-i-amber-500 focus:ring-i-amber-500 border-i-amber-500'>
