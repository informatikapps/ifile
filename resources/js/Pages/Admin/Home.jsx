            ...
            <div className='flex w-full'>
                ...
                <div className='w-4/5 px-5 py-10'>
                    ...
                    <div className='flex items-center justify-end w-full py-3'>
                        <a href={route('tambah-mahasiswa')} className='px-5 py-2 text-sm text-white rounded-md bg-i-amber-500'>+ Tambah Data</a>
                    </div>
                    <div className='w-full my-4'>
                        <table className="w-full text-sm text-center table-auto">
                            <thead>
                                <tr className='bg-i-amber-100 '>
                                    <th className='py-2 font-semibold '>Angkatan</th>
                                    {statuses.map(status => (
                                        <th key={status} className='font-semibold '>{status}</th>
                                    ))}
