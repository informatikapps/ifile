...
import { IconCopy, IconUserCircle, IconChevronsRight, IconTrash, IconPencil, IconChevronsLeft, IconArrowUpRight, IconCheck } from '@tabler/icons-react';
                            ...
                            {currentFiles && currentFiles.map((file, index) => (
                                <tbody>
                                    <tr key={index} className={`text-left ${index % 2 === 0 ? 'bg-i-amber-50' : 'bg-white'}`}>
                                        ...
                                        <td className='flex border-b-[1px] border-i-amber-500 items-center justify-center gap-2 px-4 py-2'>
